...
import { StickerItem, clamp, generateId, getRotatedBounds } from './StickerItem.js?v=1.8.6';
import { ImageItem }      from './ImageItem.js?v=1.8.6';
import { TextItem }       from './TextItem.js?v=1.8.6';
import { ShapeItem }     from './ShapeItem.js?v=1.8.6';
import { CropController } from './CropController.js?v=1.8.6';

import { HistoryManager } from './HistoryManager.js?v=1.8.6';
import { GuidesManager }  from './GuidesManager.js?v=1.8.6';
import { PointerController } from './PointerController.js?v=1.8.6';
import { PaperManager }   from './PaperManager.js?v=1.8.6';
import { FONTS }          from '../pb.config.js?v=1.8.6';
